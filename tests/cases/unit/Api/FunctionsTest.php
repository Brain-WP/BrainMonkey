...
class FunctionsTest extends UnitTestCase
{
    ...
    public function testStubsTranslationsReturn()
    {
        ...
        static::assertSame(['singular' => 'Foo', 'plural' => 'Foos'], _n_noop('Foo', 'Foos'));
        static::assertSame(['singular' => 'Foo', 'plural' => 'Foos'], _nx_noop('Foo', 'Foos'));
        static::assertSame('Foo', translate_nooped_plural(['singular' => 'Foo', 'plural' => 'Foos'], 1));
        static::assertSame('Foos', translate_nooped_plural(['singular' => 'Foo', 'plural' => 'Foos'], 2));
    }
